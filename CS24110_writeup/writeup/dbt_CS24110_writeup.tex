...
%TODO do lab algorithm/equations/histogram equalisation
...
\begin{algorithm}[h!] %histogram equalisation
	...
	\begin{algorithmic}[1]
		\Function{HistogramEqualisation} {$I$} \Comment{where $K = 256$}
...
The first operation is Automatic Contrast Adjustment on the RGB channel. To achieve that the implementation needs to %FINISH THIS, also LAB equalisation and filter
